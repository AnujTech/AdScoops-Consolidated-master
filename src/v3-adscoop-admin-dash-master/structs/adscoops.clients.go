...
func (c *Client) FindOne(userID string) error {

	var getClient Client
	if err := AdscoopsDB.Table("adscoop_clients").Where("hide_from_dash = 0 ").Find(&getClient).Error; err != nil {
		return err
	}
...
func (c *Client) FindClient(userID uint) error {
