...
func statsQuery(timeslice time.Time, trackingMethod uint, clientID uint) *gorm.DB {
	...
	query := AdscoopsDB.LogMode(true).Raw("call clientStats(?,?,?)",timeslice.Format("2006-01-02 15:04:05"),trackingMethod,clientID)
...
func impsrevQuery(timeslice time.Time, endTimeslice time.Time) *gorm.DB {
  ...
  return AdscoopsDB.LogMode(true).Raw("call getDailyImpressionCount(?,?)", timeslice.Format("2006-01-02 15:04:05"), endTimeslice.Format("2006-01-02 15:04:05"))
...
func impsrevByVertQuery(trackingMethod uint, timeslice time.Time, endTimeslice time.Time) *gorm.DB {
	...
	return AdscoopsDB.LogMode(true).Raw("call getDailyImpressionsCountByVertical(?,?,?)",trackingMethod,timeslice.Format("2006-01-02 15:04:05"),endTimeslice.Format("2006-01-02 15:04:05"))
...
func impsrevGroupByVertQuery(trackingMethod uint, timeslice time.Time, endTimeslice time.Time) *gorm.DB {
	...
	return AdscoopsDB.LogMode(true).Raw("call getDailyImpressionsCountByVerticalGroup(?,?,?)",trackingMethod,timeslice.Format("2006-01-02 15:04:05"),endTimeslice.Format("2006-01-02 15:04:05"))
