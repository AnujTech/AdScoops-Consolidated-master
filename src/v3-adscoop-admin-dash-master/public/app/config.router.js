            ...
            function($stateProvider, $urlRouterProvider) {
                ...
                $stateProvider
                    ...
                    .state('admin.adscoops.clients-viewall', {
                        url: '/clients/viewall',
                        templateUrl: 'views/adscoops.clients-viewall_old.html',
                        resolve: {
                            deps: [
                                '$ocLazyLoad',
                                function($ocLazyLoad) {
                    ...
                    .state('admin.broadvidvideos.domains-new', {
                      ...
                      // added by nirmal singh on 26th oct 2016
                    .state('admin.clientdetails', {
                        url: '/clients/detail/{id:[0-9]{1,11}}',
                        templateUrl: 'views/adscoops.clients-details.html',
                        ncyBreadcrumb: {
                            label: 'ClientDetail',
                            description: ''
                        },
